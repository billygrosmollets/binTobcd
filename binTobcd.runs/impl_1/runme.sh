...
HD_PWD='C:/Users/billy/Documents/binTobcd/binTobcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bin2bcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_bin2bcd.tcl -notrace
